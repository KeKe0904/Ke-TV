...
**同时适配 TV 和手机**：在电视上是屏保服务（DreamService），在手机上是带预览功能的工具 APP，方便先在手机上测试图床配置效果再投到电视上。
...
- 一键跳转系统屏保设置
- 单图加载失败自动跳过
- **手机端预览**：在手机上全屏预览屏保效果，单击退出

## 下载 APK

到 [Releases](../../releases) 页下载最新 `TVToolbox-v1.x.apk`。

| 版本 | 说明 |
|------|------|
| v1.1 | 同时适配 TV + 手机，新增手机端预览 |
| v1.0 | 初版，仅 TV 屏保 |

## 安装

1. 把 APK 拷到 U 盘，插到电视 USB 口，用电视自带的「文件管理」打开安装
   - 或用 `adb install TVToolbox-v1.x.apk`
...
### 手机端（推荐先用手机测试）
1. 打开「TV 工具箱」→ 卡片式主页
2. 点「屏保设置」配置图床 URL、间隔、动效
3. 点「预览屏保效果」全屏播放，单击退出
4. 配置好后投到电视上用
